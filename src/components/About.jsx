...
function About() {
  return (
    <div data-scroll  data-scroll-speed="0.1" className='relative z-2 -mt-18  flex flex-col items-center  bg-[#CDEA68]  rounded-tl-3xl   rounded-tr-3xl  text-zinc-900'>
        ...
        <div className='grid grid-col w-full  grid-cols-3 gap-10 text-xl leading-[30px]'> 
         ...
         <div className='col-span-2 w-[45vw] h-[30vw] bg-[#CDEA] mt-20 rounded-[30px] '> <img src="photo" alt="my photo" className='h-fit'/></div>
