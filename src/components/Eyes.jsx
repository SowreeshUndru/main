...
function Eyes() {
  ...
  return (
    <div  className='overflow-hidden -mt-18 overflow-hidden flex justify-center bg-white h-[100vh] w-[100vw]'>
      <div  data-scroll data-scroll-speed="-.7"    className='relative z-1 overflow-hidden mt-40 h-[80vh] w-[80vw] flex justify-center items-center bg-cover bg-center bg-[url("../images/canva-green-illustrative-organic-plant-zoom-virtual-background-fpJFOduK3w4.jpg")]'>
